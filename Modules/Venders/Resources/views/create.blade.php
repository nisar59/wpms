...
<form action="{{url('venders/store')}}" method="post">
  @csrf
  <div class="row">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" min="0" class="form-control" name="phone" placeholder="Enter Phone">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="gps_coordinates" placeholder="Enter GPS Coordinates">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="shop_or_business_address" placeholder="Enter Shop or Business Address">
              </div>
            </div>
          </div>
        </div>
