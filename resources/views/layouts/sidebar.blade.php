            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{url('water-quality-test-parameters')}}">Water Quality Test Parameters</a></li>
                        @endcan
                        <!-- doners -->
                        @can('donors')
                ...
                @endcan
                <!-- Water Quality Test -->
                @can('water-quality-test')
                <!--                 <li class="menu-title">Water Quality Test</li>
                -->                <li>
                    <a href="{{url('water-quality-test')}}" class="waves-effect">
