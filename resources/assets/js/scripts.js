...
$(function () {
  ...
  if($('.select-layout:checked').val()==1){
    jQuery("body").addClass("light");
    jQuery("body").addClass("light-sidebar");
    jQuery("body").addClass("theme-"+$(".choose-theme li.active").attr('title'));
  ...
  if($('.select-sidebar:checked').val()==1){
...
var mini_sidebar = $('#mini_sidebar_setting').is(":checked") ? "checked" : "unchecked";
    if (mini_sidebar === "checked") {
      toggle_sidebar_mini(true);
    } else {
      toggle_sidebar_mini(false);
    }
});
var sticky_header = $('#sticky_header_setting').is(":checked") ? "checked" : "unchecked";
if (sticky_header === "checked") {
      toggle_sticky_header(true);
}
else{
